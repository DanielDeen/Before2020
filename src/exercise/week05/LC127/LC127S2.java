...
public class LC127S2 {
    public static void main(String[] args) {
        String beginWord = "hit";
        String endWord = "cog";
        List<String> wordList = Arrays.asList(new String[]{"hot", "dot", "dog", "lot", "log", "cog"});
        System.out.println(new LC127S2().ladderLength(beginWord, endWord, wordList));
    }
    ...
    public int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        return dfs(wordSet, headSet, tailSet, 2);
    }

    private int dfs(HashSet<String> wordSet, HashSet<String> headSet, HashSet<String> tailSet, int depth) {
        if (headSet.size() > tailSet.size()) {
            return dfs(wordSet, tailSet, headSet, depth);
        }
